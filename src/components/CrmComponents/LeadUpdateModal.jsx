...
import { CircleAlert, SquarePen, UserRoundPlus } from "lucide-react";
...
export default function LeadUpdateModal({ data }) {
  ...
  // timeline data
  const timeline = [
    { name: "Within 1 Month", value: "1 months" },
    { name: "1–3 Months", value: "1–3 months" },
    { name: "O3–6 Months", value: "3-6 months" },
